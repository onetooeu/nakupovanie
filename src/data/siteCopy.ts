...
export const siteCopy: Record<Lang, SiteCopy> = {
  sk: {
    ...
    hero: {
      ...
      title:
        'nakupovanie.sk / nakupovani.cz — unikátna ponuka dvojice prémiových domén pre internetové projekty na Slovensku a v Česku, ktorá sa na trhu objavuje len výnimočne.',
      subtitle:
...
Firmy sa najprv zaregistrujú, následne sú zaradené do databázy a potom môžu vstúpiť do uzavretého kola alebo využiť okamžitú kúpu.`,
  ...
  cz: {
    ...
    hero: {
      eyebrow: 'Private acquisition process • B2B only • TFWS 2.0 ready',
      title:
        'nakupovanie.sk / nakupovani.cz — unikátní nabídka dvojice prémiových domén pro internetové projekty na Slovensku a v Česku, která se na trhu objevuje jen výjimečně.',
      subtitle:
...
Firmy se nejprve zaregistrují, následně jsou zařazeny do databáze a poté mohou vstoupit do uzavřeného kola nebo využít okamžitou koupi.`,
  ...
  en: {
    ...
    hero: {
      eyebrow: 'Private acquisition process • B2B only • TFWS 2.0 ready',
      title:
        'nakupovanie.sk / nakupovani.cz — a unique offer of two premium domains for internet projects in Slovakia and the Czech Republic, appearing on the market only exceptionally.',
      subtitle:
